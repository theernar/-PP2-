...
#2-ші функция: қолданушыны name және phone арқылы қосу (бар болса - update)    
def insert_or_update_user():
    ...
    try:
        ...
        conn.commit()
        print("Процедура сәтті орындалды.")
...
def menu():
    ...
    while True:
        ...
        print("6. Adding informations by name and phone number. If exists - update")
        print("0. Exist")
